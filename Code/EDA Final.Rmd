...
crypto_df <- read_excel("/Users/ashleshkhajbage/Documents/CRYPTO Project/crypto_data.xlsx")
...
```
```{r}
write.csv(bitcoin_df, "/Users/ashleshkhajbage/Documents/Bitcoin.csv", row.names = FALSE)
```
